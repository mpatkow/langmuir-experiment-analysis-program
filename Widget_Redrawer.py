...
class Widget_Redrawer:
    def redraw_widgets(self, self_of_parent):
        ...
        # SMOOTHING
        self_of_parent.sorting_label_1.pack()
        ...
        # MATH
        self_of_parent.sorting_label_2.pack()
        ...
        # OPERATIONS
        self_of_parent.sorting_label_3.pack()
        ...
        # SMOOTHING
        self_of_parent.sorting_label_4.pack()
        self_of_parent.trim_button.pack()
        self_of_parent.hide_button.pack()
        self_of_parent.emphasize_button.pack()
"""
