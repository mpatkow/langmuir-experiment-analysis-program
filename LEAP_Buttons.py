    ...
    def __init__(self, tkinter_frame=False):
        if mode == True:
            ...
            tkinter_frame.oml_button = ctk.CTkButton(master = tkinter_frame.math_frame,
                    ...
                    text = "oml")
            tkinter_frame.d_temp_button = ctk.CTkButton(master = tkinter_frame.math_frame,
            ...
            tkinter_frame.pan_button = tk.Button(master = tkinter_frame.adding_frame,
                    command = tkinter_frame.fig.canvas.toolbar.pan,
                    text = "pan")
            tkinter_frame.trim_button = tk.Button(master = tkinter_frame.adding_frame,
                    command = tkinter_frame.trim,
                    text = "trim")
            ...
            tkinter_frame.rescale_button = tk.Button(master = tkinter_frame.options_frame,
                    command = tkinter_frame.rescale,
                    text = "Rescale")
            ...
            tkinter_frame.legend_button = tk.Button(master = tkinter_frame.options_frame,
                    command = tkinter_frame.toggle_legend,
                    text = "legend")
            tkinter_frame.box_button = tk.Button(master = tkinter_frame.math_frame,
                    command = tkinter_frame.box_average,
                    text = "box average")
            ...
            tkinter_frame.fit_counter = tk.Label(master = tkinter_frame.cursor_frame, textvar = tkinter_frame.fit_bound[0])
            tkinter_frame.fit_counter_2 = tk.Label(master = tkinter_frame.cursor_frame, textvar = tkinter_frame.fit_bound[1])
            ...
            tkinter_frame.open_help_and_options_button = tk.Button(master = tkinter_frame.options_frame,
                    command = tkinter_frame.open_help_and_options,
                    text = "h&o")
